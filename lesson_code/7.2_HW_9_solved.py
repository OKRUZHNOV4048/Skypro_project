# Теперь мы предоставим вам структуру данных с высокой вложенностью.
# Это данные экскурсоводов. Выведите экскурсоводов, у которых количество туров больше или равно 5.
...
guides_with_more_4 = {}
guides_with_more_4_list = []
key_count = 1


for i in guides:
    if i["fields"]["tours_count"] > 4:
        guides_with_more_4[f"full_name_{key_count}"] = i["fields"]["full_name"]
        guides_with_more_4[f"tours_count_{key_count}"] = i["fields"]["tours_count"]
        guides_with_more_4_list.append(guides_with_more_4)
        guides_with_more_4 = {}
        key_count += 1

for i in guides_with_more_4_list:
    print(i[f"full_name_{guides_with_more_4_list.index(i)+1}"],
          "| туров:", i[f"tours_count_{guides_with_more_4_list.index(i)+1}"])
